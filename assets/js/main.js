...
sr.reveal('.skills__name-buttom', {origin:'bottom',distance: '100px', delay: 30, interval: 100})
sr.reveal('.skills__img', {delay: 300})

/*SCROLL PORTFOLIO*/
sr.reveal('.portfolio__img', {interval: 200})
sr.reveal('.portfolio__img-buttom', {origin:'bottom',interval: 200})

/*SCROLL CONTACT*/
sr.reveal('.contact__subtitle', {delay: 30})
sr.reveal('.contact__text', {delay: 30,interval: 200})
